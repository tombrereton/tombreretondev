...
export const article = {
  author: 'Tom Brereton',
  date: '2023-07-14',
  title: 'Streamlining Integration Tests in .NET with Testcontainers',
  description:
    'Discover the power of Testcontainers in .NET for reliable integration testing. Learn how to set up, configure, and write integration tests using Docker containers for a seamless testing experience.',
}
